...
class AboutUserPatient(forms.ModelForm):
    ...
    date_of_birth = forms.DateField(
        widget=forms.DateInput(attrs={"type": "date", "placeholder": "ГГГГ-ММ-ДД", "style": "background-color: #F1F1F1", "contenteditable": "true"}))
    date_of_operation = forms.DateField(
        widget=forms.DateInput(attrs={"type": "date", "placeholder": "ГГГГ-ММ-ДД", "style": "background-color: #F1F1F1"}))
